...
| Literal full-cluster baseline | FAIL - 264 raw violations across 39 violating objects; 53 root-owner remediation groups, 26 violating running Pods, zero runtime-drift groups; 218 workload objects checked (checked count varies with DaemonSet replicas and rollouts) | 2026-07-18 |
